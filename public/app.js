...
var sliderContent = [{
  ...
  content: [{
    text1: 'Move ',
    text2: /*#__PURE__*/react.createElement("span", {
    ...
    text1: 'Turn ',
    text2: /*#__PURE__*/react.createElement(Icon, {
      name: "redo",
      size: 15,
    ...
    text1: 'go to ',
    text2: /*#__PURE__*/react.createElement("select", {
      className: "bg-blue-700"
    }, /*#__PURE__*/react.createElement("option", {
      value: "random position"
    }, "random position"), /*#__PURE__*/react.createElement("option", {
      value: "mouse-pointer"
    }, "mouse-pointer")),
    onClick: 'randomEvent'
  }, {
    ...
    text3: ' y :',
    text4: /*#__PURE__*/react.createElement("span", {
      contentEditable: "true",
      suppressContentEditableWarning: "true"
    }, "0"),
    onClick: 'xyEvent'
    ...
    text3: ' secs to',
    text4: /*#__PURE__*/react.createElement("select", {
      className: "bg-blue-700"
    }, /*#__PURE__*/react.createElement("option", {
      value: "random position"
    }, "random position"), /*#__PURE__*/react.createElement("option", {
...
/* harmony default export */ var events = (sliderContent);
...
function Sidebar(props) {
  return /*#__PURE__*/react.createElement("div", {
    className: "w-96 flex-none h-full flex flex-col items-start p-2 border-r border-gray-200",
    onDrop: props.drop,
    ...
    return /*#__PURE__*/react.createElement(react.Fragment, {
      ...
      className: "font-bold collapsible bg-" + item.color + "-500 " + (i == 0 ? "active" : ""),
      onClick: props.expand
    }, " ", item.text, " "), /*#__PURE__*/react.createElement("div", {
      className: "content " + (i == 0 ? "con" : "")
    }, item.content.map(function (innerItem, j) {
      return /*#__PURE__*/react.createElement("div", {
        key: "inner" + innerItem.onClick + j,
        ...
        size: "12",
        className: "text-white mx-2"
      }), innerItem.text1, innerItem.text2, innerItem.text3, innerItem.text4, innerItem.text5, /*#__PURE__*/react.createElement(Icon, {
        name: "plus-circle",
        size: "12",
        className: "text-white mx-2"
      }));
...
function MidArea(props) {
  return /*#__PURE__*/react.createElement("div", {
    className: "flex-1 h-full overflow-auto bg-white",
    onDrop: props.drop,
    onDragOver: function onDragOver(e) {
      return e.preventDefault();
    }
...
function App() {
  ...
  (0,react.useEffect)(function () {
    var x = (ref.current.parentNode.offsetWidth - ref.current.getAttributeNode('width').nodeValue) / 2;
    var y = (ref.current.parentNode.offsetHeight - ref.current.getAttributeNode('height').nodeValue) / 2;
    setCanvas({
      x: x,
      y: y
    });
  ...
  var onEventClick = function onEventClick(e) {
    var x = e.target.getElementsByTagName('span')[0];
    var x2 = e.target.getElementsByTagName('span')[1];
    var x3 = e.target.getElementsByTagName('span')[1];
    var y = e.target.getElementsByTagName('select')[0];
    if (x || x2 || x3 || y) action(e.target.title, [x ? x.innerHTML : 0, x2 ? x2.innerHTML : 0, y ? y.value : 0]);
    if (e.target.a) document.getElementById(e.target.a).click();
  };

  var action = function action(a, b) {
    console.log("b: " + b[0]);
    ...
    switch (a) {
      ...
      case "randomEvent":
        if (b[2] == "mouse-pointer") transform(mouse.x, mouse.y, 0, 0, 1);else transform(canvas.x * 2 * Math.random(), canvas.y * 2 * Math.random(), 0, 0, 1);
        break;
      ...
      case "randomEventTime":
        if (b[2] == "mouse-pointer") transform(mouse.x, mouse.y, 0, b[0], 1);else transform(canvas.x * 2 * Math.random(), canvas.y * 2 * Math.random(), 0, b[0], 1);
        break;
    }
  };

  var transform = function transform(x, y, r, t, o) {
    var values = window.getComputedStyle(ref.current, null).getPropertyValue("transform");
    var transformValue = [0, 0, 0];
    ...
    var newRadian = transformValue[2] + r * (Math.PI / 180);
    if (t) ref.current.style.transitionDuration = t + 's';else ref.current.style.transitionDuration = 'none';
  ...
  var drop = function drop(e) {
    ...
    if (data) {
      ...
      var eventPanel = document.getElementsByClassName('w-96')[0];
  ...
  var minus = function minus(e) {
    var mPointer = e.target.getBoundingClientRect();
    var pointer = {
    ...
    if (localStorage.getItem('pointer-x')) {
      ...
      var ele = document.getElementById('line1').cloneNode(true);
      ele.id += document.getElementsByClassName('line').length;
      ele.style.left = pointer.x + 'px';
      ele.style.top = pointer.y + 'px';
      var angle = (pointer.x - mPointer.x) / (pointer.y - mPointer.y) * -1;
  ...
  var remove = function remove(e) {
    e.preventDefault();
    var data = e.dataTransfer.getData("text/html");
    if (data.charAt(0) == 'm') document.getElementById(data).remove();
  };

  return /*#__PURE__*/react.createElement("div", {
    className: "bg-blue-100 font-sans parent"
  }, /*#__PURE__*/react.createElement("div", {
    className: "pt-2 pb-2 pl-96 pr-96"
  }, /*#__PURE__*/react.createElement(Icon, {
    name: "stop",
    className: "text-red-600 mx-2 inline-block float-right"
  }), /*#__PURE__*/react.createElement(Icon, {
    name: "flag",
    className: "text-green-600 mx-2 inline-block float-right"
  }), /*#__PURE__*/react.createElement("span", {
    className: "inline-block"
  }, "Mouse Position - x: " + mouse.x + " y: " + mouse.y)), /*#__PURE__*/react.createElement("div", {
